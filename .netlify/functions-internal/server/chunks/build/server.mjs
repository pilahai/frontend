...
import { i as hasProtocol, m as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch, o as createHooks, p as executeAsync, e as createError$1, t as toRouteMatcher, q as createRouter$1, v as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DOXWw22Z.mjs')
  },
  {
    name: "history",
    path: "/history",
    component: () => import('./history-Cojr1A85.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BfuI48Gk.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dpbx13dW.mjs'));
