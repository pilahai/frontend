...
import { j as joinRelativeURL, u as useRuntimeConfig, g as getResponseStatusText, a as getResponseStatus, b as defineRenderHandler, c as getQuery, e as createError, f as destr, h as getRouteRules, i as hasProtocol, k as joinURL, l as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"manifest","href":"manifest.webmanifest"},{"rel":"icon","type":"image/png","href":"/logo-pilahai-square-transparent-192.png"}],"style":[],"script":[],"noscript":[]};
...
const entryFileName = "L8p6NzeM.js";
